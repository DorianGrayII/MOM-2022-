namespace UnityEngine.PostProcessing
{
    ...
    public sealed class MotionBlurComponent : PostProcessingComponentCommandBuffer<MotionBlurModel>
    {
        ...
        public override bool active
        {
            ...
            {
                MotionBlurModel.Settings settings = base.model.settings;
                if (!base.model.enabled || (((settings.shutterAngle <= 0f) || !this.reconstructionFilter.IsSupported()) && (settings.frameBlending <= 0f)))
                {
                    return false;
                }
                return ((SystemInfo.graphicsDeviceType != GraphicsDeviceType.OpenGLES2) && !base.context.interrupted);
            }
        }
        ...
        public class ReconstructionFilter
        {
            ...
            public void ProcessImage(PostProcessingContext context, CommandBuffer cb, ref MotionBlurModel.Settings settings, RenderTargetIdentifier source, RenderTargetIdentifier destination, Material material)
            {
                ...
                cb.Blit((RenderTargetIdentifier) nameID, num5, material, 1);
                ...
                cb.Blit((RenderTargetIdentifier) num5, num6, material, 2);
                ...
                cb.Blit((RenderTargetIdentifier) num6, num7, material, 2);
                ...
                cb.Blit((RenderTargetIdentifier) num7, num8, material, 3);
                ...
                cb.Blit((RenderTargetIdentifier) num8, num9, material, 4);
