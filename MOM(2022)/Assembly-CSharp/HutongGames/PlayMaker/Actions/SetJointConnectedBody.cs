namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, CheckForComponent(typeof(Joint)), HutongGames.PlayMaker.Tooltip("The joint to connect. Requires a Joint component.")]
        ...
        public override void OnEnter()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                if (component != null)
                {
                    component.connectedBody = this.rigidBody.get_Value()?.GetComponent<Rigidbody>();
                }
            }
            base.Finish();
        }
