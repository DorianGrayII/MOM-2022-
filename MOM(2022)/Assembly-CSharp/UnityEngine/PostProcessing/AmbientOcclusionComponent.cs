...
namespace UnityEngine.PostProcessing
{
    public sealed class AmbientOcclusionComponent : PostProcessingComponentCommandBuffer<AmbientOcclusionModel>
    {
        ...
        private OcclusionSource occlusionSource
        {
            get
            {
                if (base.context.isGBufferAvailable && !base.model.settings.forceForwardCompatibility)
                {
                    return OcclusionSource.GBuffer;
                }
                if (base.model.settings.highPrecision && (!base.context.isGBufferAvailable || base.model.settings.forceForwardCompatibility))
                {
        ...
        private bool ambientOnlySupported
        {
            get
            {
                if (base.context.isHdr && base.model.settings.ambientOnly && base.context.isGBufferAvailable)
                {
        ...
        {
            if (!this.ambientOnlySupported || base.context.profile.debugViews.IsModeActive(BuiltinDebugViewsModel.Mode.AmbientOcclusion))
            {
        ...
        public override void PopulateCommandBuffer(CommandBuffer cb)
        {
            ...
            Material material = base.context.materialFactory.Get("Hidden/Post FX/Ambient Occlusion");
            ...
            cb.Blit(null, occlusionTexture, material, (int)this.occlusionSource);
            ...
            cb.Blit(occlusionTexture, occlusionTexture2, material, (this.occlusionSource == OcclusionSource.GBuffer) ? 4 : 3);
            ...
            else
            {
                ...
                cb.GetTemporaryRT(tempRT, base.context.width, base.context.height, 0, FilterMode.Bilinear, format);
