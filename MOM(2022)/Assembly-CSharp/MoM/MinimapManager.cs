...
public class MinimapManager : MonoBehaviour
{
    ...
    private void GroupMovement(object sender, object e)
    {
        ...
        if (group == null && sender is global::MOM.Location location)
        {
    ...
    public void RegisterEvents()
    {
        ...
        MHEventSystem.RegisterListener<global::MOM.Group>(GroupMovement, this);
        MHEventSystem.RegisterListener<World>(PlaneChanged, this);
        MHEventSystem.RegisterListener<global::MOM.Location>(GroupMovement, this);
    }
    ...
    private void UpdatePOI()
    {
        ...
        foreach (KeyValuePair<int, Entity> entity in EntityManager.Get().entities)
        {
            ...
            if (!(entity.Value is global::MOM.Group group2) || (group2.GetPlane() != plane && !(group2.GetLocationHostSmart()?.otherPlaneLocation != null)))
            {
                continue;
            }
            group = group2;
            ...
            else
            {
                ...
                if (group != null)
                {
                    global::MOM.Group group3 = group;
                    foreach (Reference<global::MOM.Unit> unit in group3.GetUnits())
                    {
