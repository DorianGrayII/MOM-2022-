    ...
    public class UnitInfo : ScreenBase
    {
        ...
        public object unit
        {
            ...
            set
            {
                ...
                Unit u = value as Unit;
                if (u != null && u.group != null)
                {
                    this._group = u.group.Get();
                    if (this._group.GetUnits().Find((Reference<Unit> o) => o.Get() == u) == null)
                    {
                        this._group = null;
                    }
                }
        ...
        public override IEnumerator PreStart()
        {
            ...
            if (this.multipleUnitsOffer)
            {
                ...
                {
                    Unit selectedObject = this.gridOfferedCharacters.GetSelectedObject<Unit>();
        ...
        public void SetHeroJoin(Unit hero, SimpleCallback callback)
        {
        ...
        private int GetFigures()
        {
            ...
            {
                return (this.unit as Unit).figureCount;
            }
            if (this.unit is global::DBDef.Unit)
            {
        ...
        private int GetMaxFigures()
        {
            if (this.unit is Unit)
            {
                return (this.unit as Unit).MaxCount();
            }
            if (this.unit is global::DBDef.Unit)
            {
                return (this.unit as global::DBDef.Unit).figures;
        ...
        {
            if (this.unit is Unit || this.unit is global::DBDef.Unit || this.unit is BattleUnit)
            {
        ...
        private DescriptionInfo GetDI()
        {
            if (this.unit is Unit)
            {
                return (this.unit as Unit).dbSource.Get().GetDescriptionInfo();
            }
            if (this.unit is global::DBDef.Unit)
            {
