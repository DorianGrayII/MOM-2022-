...
public class CraftingQueue
{
    ...
    public void AdvanceQueue()
    {
        ...
        else
        {
            ...
            while (this.craftingItems.Count > 0 && (num > 0 || this.craftingItems[0].progress == this.craftingItems[0].requirementValue))
            {
                ...
                {
                    global::MOM.Unit unit = global::MOM.Unit.CreateFrom((global::DBDef.Unit)craftingItem.craftedUnit);
                        ...
                        for (int i = 1; i < 4; i++)
                        {
                            ...
                            foreach (Vector3i item in rangeSimple)
                            {
                                ...
                                if (target != Vector3i.invalid)
                                {
                                    ...
                                    {
                                        global::MOM.Group group = groupsOfPlane.Find((global::MOM.Group o) => o.GetPosition() == target);
                                ...
                                {
                                    target = vector3i;
                                    global::MOM.Group group2 = groupsOfPlane.Find((global::MOM.Group o) => o.GetPosition() == target);
                                    flag2 = ((group2 != null && group2.GetOwnerID() != this.owner.Get().GetOwnerID()) ? true : false);
                                }
                            }
                            if (target != Vector3i.invalid)
                            {
                                global::MOM.Group group3 = groupsOfPlane.Find((global::MOM.Group o) => o.Position == target);
                                if (group3 == null)
                                {
                                    global::MOM.Group group4 = new global::MOM.Group(plane, this.owner.Get().GetOwnerID());
    ...
    public void CleanUnitFromQueue(global::MOM.Unit unit)
    {
