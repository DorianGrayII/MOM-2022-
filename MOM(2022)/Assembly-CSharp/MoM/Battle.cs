...
public class Battle : IEnchantable
{
    ...
    public List<global::MOM.Unit> sources = new List<global::MOM.Unit>();
    ...
    public Dictionary<BattleUnit, global::MOM.Unit> buToSource = new Dictionary<BattleUnit, global::MOM.Unit>();
    ...
    public global::MOM.Group gAttacker;

    public global::MOM.Group gDefender;
    ...
    public Battle(List<Reference<global::MOM.Unit>> attacker, List<Reference<global::MOM.Unit>> defender, int attackerWizzardID, int defenderWizzardID)
    {
        ...
        foreach (Reference<global::MOM.Unit> item in attacker)
        {
        ...
        foreach (Reference<global::MOM.Unit> item2 in defender)
        {
        ...
        global::MOM.Location location = this.gDefender.GetLocationHost();
        ...
        foreach (Reference<global::MOM.Unit> item3 in attacker)
        {
        ...
        foreach (Reference<global::MOM.Unit> item4 in defender)
        {
    ...
    public static Battle Create(global::MOM.Group attacker, global::MOM.Group defender)
    {
    ...
    public BattleUnit CreateSummon(int owner, Subrace unit, Vector3i pos)
    {
        ...
        global::MOM.Unit unit2 = global::MOM.Unit.CreateFrom(unit);
    ...
    public void ApplyResultsToUnits(BattleResult br)
    {
        ...
        foreach (global::MOM.Unit unit in this.sources)
        {
    ...
    public void ApplyFleeDamages(bool attacker)
    {
        ...
        foreach (BattleUnit item2 in list)
        {
            if (this.buToSource.ContainsKey(item2))
            {
                ...
                {
                    global::MOM.Unit unit = this.buToSource[item2];
    ...
    public static void ApplyBattleChanges(Battle b)
    {
        ...
        if (b.defender.surrendered && b.gAttacker != null && b.gDefender != null)
        {
            ...
            {
                global::MOM.Group groupD = b.gDefender;
    ...
    private void ApplyChanges()
    {
        int num = 0;
        int num2 = 0;
        foreach (KeyValuePair<BattleUnit, global::MOM.Unit> item in this.buToSource)
        {
        ...
        foreach (KeyValuePair<BattleUnit, global::MOM.Unit> item2 in this.buToSource)
        {
        ...
        {
            foreach (KeyValuePair<BattleUnit, global::MOM.Unit> item3 in this.buToSource)
            {
                ...
                if (item3.Key.isAnimatedInSimulation)
                {
                    ...
                    global::MOM.Group group3 = item3.Value.group;
                ...
                if (flag2)
                {
                    global::MOM.Unit value = item3.Value;
    ...
    private static void TryToReanimateAsUndead(Battle b, BattleUnit bu, global::MOM.Unit deadUnit, PlayerWizard winner, global::MOM.Group group)
    {
        ...
        {
            global::MOM.Unit unit = ((deadUnit.dbSource == (Subrace)UNIT.LIF_ARCH_ANGEL) ? global::MOM.Unit.CreateFrom((Subrace)UNIT.DTH_ARCH_ANGEL) : ((deadUnit.dbSource == (Subrace)UNIT.CHA_EFREET) ? global::MOM.Unit.CreateFrom((Subrace)UNIT.DTH_EFREET) : ((!(deadUnit.dbSource == (Subrace)UNIT.SOR_DJINN)) ? global::MOM.Unit.CreateFrom(deadUnit.dbSource) : global::MOM.Unit.CreateFrom((Subrace)UNIT.DTH_DJINN))));
        ...
        else
        {
            ...
            global::MOM.Unit unit2 = global::MOM.Unit.CreateFrom((Subrace)UNIT.DTH_ZOMBIES);
