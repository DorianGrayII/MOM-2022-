namespace UnityEngine.PostProcessing
{
    ...
    public sealed class ScreenSpaceReflectionComponent : PostProcessingComponentCommandBuffer<ScreenSpaceReflectionModel>
    {
        ...
        public override void PopulateCommandBuffer(CommandBuffer cb)
        {
            ...
            mat.SetInt(Uniforms._BilateralUpsampling, this.k_BilateralUpsample ? 1 : 0);
            mat.SetInt(Uniforms._TreatBackfaceHitAsMiss, this.k_TreatBackfaceHitAsMiss ? 1 : 0);
            mat.SetInt(Uniforms._AllowBackwardsRays, settings.reflection.reflectBackfaces ? 1 : 0);
            mat.SetInt(Uniforms._TraceBehindObjects, this.k_TraceBehindObjects ? 1 : 0);
            ...
            mat.SetInt(Uniforms._HighlightSuppression, this.k_HighlightSuppression ? 1 : 0);
            ...
            RenderTextureFormat format = base.context.isHdr ? RenderTextureFormat.ARGBHalf : RenderTextureFormat.ARGB32;
            ...
            cb.GetTemporaryRT(num12, width, height, 0, this.k_BilateralUpsample ? FilterMode.Point : FilterMode.Bilinear, format);
            ...
            cb.Blit((RenderTargetIdentifier) num12, this.m_ReflectionTextures[0], mat, 8);
            for (int j = 1; j < 5; j++)
            {
                int dest = this.m_ReflectionTextures[j - 1];
                int num18 = j;
                ...
                cb.Blit((RenderTargetIdentifier) dest, num11, mat, 2);
                cb.SetGlobalVector(Uniforms._Axis, new Vector4(0f, 1f, 0f, 0f));
                dest = this.m_ReflectionTextures[j];
                cb.Blit((RenderTargetIdentifier) num11, dest, mat, 2);
                cb.ReleaseTemporaryRT(num11);
            }
            cb.Blit((RenderTargetIdentifier) this.m_ReflectionTextures[0], num13, mat, 3);
        ...
        public override bool active
        {
            get
            {
                return (base.model.enabled && (base.context.isGBufferAvailable && !base.context.interrupted));
            }
        }
