namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Quaternion), HutongGames.PlayMaker.Tooltip("Spherically interpolates between from and to by t.")]
    public class QuaternionSlerp : QuaternionBaseAction
    {
        ...
        {
            this.storeResult.set_Value(Quaternion.Slerp(this.fromQuaternion.get_Value(), this.toQuaternion.get_Value(), this.amount.Value));
        }
