namespace UnityEngine.PostProcessing
{
    public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
    {
        ...
        private Texture2D GetCurveTexture()
        {
            ...
            {
                this.m_GradingCurves = new Texture2D(128, 2, this.GetCurveFormat(), mipChain: false, linear: true)
                {
            ...
            this.m_GradingCurves.Apply(updateMipmaps: false, makeNoLongerReadable: false);
        ...
        private void GenerateLut()
        {
            ...
            Material material = base.context.materialFactory.Get("Hidden/Post FX/Lut Generator");
            ...
            material.SetVector(Uniforms._Balance, this.CalculateColorBalance(settings.basic.temperature, settings.basic.tint));
            ColorGradingComponent.CalculateLiftGammaGain(settings.colorWheels.linear.lift, settings.colorWheels.linear.gamma, settings.colorWheels.linear.gain, out var outLift, out var outGamma, out var outGain);
            ...
            ColorGradingComponent.CalculateSlopePowerOffset(settings.colorWheels.log.slope, settings.colorWheels.log.power, settings.colorWheels.log.offset, out var outSlope, out var outPower, out var outOffset);
            ...
            material.SetTexture(Uniforms._Curves, this.GetCurveTexture());
        ...
        {
            RenderTexture bakedLut = base.model.bakedLut;
            GUI.DrawTexture(new Rect(base.context.viewport.x * (float)Screen.width + 8f, 8f, bakedLut.width, bakedLut.height), bakedLut);
        }
