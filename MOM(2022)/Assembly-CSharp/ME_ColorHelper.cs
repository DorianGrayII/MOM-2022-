...
public static class ME_ColorHelper
{
    ...
    public static Color ConvertRGBColorByHUE(Color rgbColor, float hue)
    {
        ...
        HSBColor hsbColor = ME_ColorHelper.ColorToHSV(rgbColor / num);
        hsbColor.H = hue;
    ...
    public static void ChangeObjectColorByHUE(GameObject go, float hue)
    {
        ...
        foreach (Renderer renderer in componentsInChildren)
        {
            ...
            string[] array2 = ME_ColorHelper.colorProperties;
        ...
        foreach (ParticleSystemRenderer particleSystemRenderer in componentsInChildren2)
        {
            ...
            foreach (string name2 in array2)
            {
                ...
                {
                    ME_ColorHelper.setMatHUEColor(trailMaterial, name2, hue);
                }
            }
        }
        ...
        {
            HSBColor hsbColor = ME_ColorHelper.ColorToHSV(obj.color);
            hsbColor.H = hue;
            obj.color = ME_ColorHelper.HSVToColor(hsbColor);
        }
        ...
        foreach (ParticleSystem obj2 in componentsInChildren6)
        {
            ...
            HSBColor hsbColor2 = ME_ColorHelper.ColorToHSV(obj2.main.startColor.color);
            hsbColor2.H = hue;
            ...
            num = Math.Abs(ME_ColorHelper.ColorToHSV(colorKeys[1].color).H - hsbColor2.H);
            hsbColor2.H = hue;
            colorKeys[0].color = ME_ColorHelper.HSVToColor(hsbColor2);
            for (int l = 1; l < colorKeys.Length; l++)
            {
                hsbColor2 = ME_ColorHelper.ColorToHSV(colorKeys[l].color);
                hsbColor2.H = Mathf.Repeat(hsbColor2.H + num, 1f);
                colorKeys[l].color = ME_ColorHelper.HSVToColor(hsbColor2);
            }
    ...
    {
        Color value = ME_ColorHelper.ConvertRGBColorByHUE(mat.GetColor(name), hueColor);
