namespace MadGoat_SSAA
{
    ...
    public class DemoGUI : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect((float) (Screen.width - 150), 10f, 150f, 50f), text);
            ...
            if (this.mode)
            {
                GUI.Label(new Rect(20f, 50f, 100f, 20f), ((int) this.multiplier).ToString() + "%");
                ...
                {
                    this.ssaa.SetAsScale((int) this.multiplier, MadGoat_SSAA.Filter.BICUBIC, 0.8f, 0.7f);
                }
            }
            else
            {
