namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DrawDebugLine : FsmStateAction
    {
        ...
        {
            Debug.DrawLine(ActionHelpers.GetPosition(this.fromObject, this.fromPosition), ActionHelpers.GetPosition(this.toObject, this.toPosition), this.color.get_Value());
        }
