namespace HutongGames.PlayMaker.Actions
{
    ...
    public class Vector3AddXYZ : FsmStateAction
    {
        ...
        private void DoVector3AddXYZ()
        {
            ...
            if (this.perSecond)
            {
                this.vector3Variable.set_Value(this.vector3Variable.get_Value() + (vector * Time.deltaTime));
            }
            else
            {
                this.vector3Variable.set_Value(this.vector3Variable.get_Value() + vector);
            }
        }
