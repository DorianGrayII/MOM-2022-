...
namespace WorldCode
{
    public class Plane
    {
        ...
        public IEnumerator RecreatePlane(DBReference<global::DBDef.Plane> planeSource, string name, int seed, Vector2i size, PlaneSettings settings)
        {
            ...
            MHEventSystem.TriggerEvent<Plane>(this, 0f);
            yield return null;
        ...
        public IEnumerator InitializePlane(DBReference<global::DBDef.Plane> planeSource, string name, int seed, Vector2i size, PlaneSettings settings)
        {
            ...
            {
                MHEventSystem.TriggerEvent<Plane>(this, (float)o * 0.1f);
            });
            if (!error)
            {
                MHEventSystem.TriggerEvent<Plane>(this, 0.1f);
                Debug.Log("T1 " + t.GetTime());
                yield return null;
                this.I6_Triangulate();
                MHEventSystem.TriggerEvent<Plane>(this, 0.2f);
                ...
                {
                    MHEventSystem.TriggerEvent<Plane>(this, 0.8f + (float)o * 0.1f);
                });
                if (!error)
                {
                    MHEventSystem.TriggerEvent<Plane>(this, 0.8f);
                    ...
                    yield return null;
                    this.I11_InitializeForeground(null);
                    MHEventSystem.TriggerEvent<Plane>(this, 0.93f);
                    Debug.Log("T6 " + t.GetTime());
                    yield return null;
                    this.I12_DesignForegroundMesh(null);
                    MHEventSystem.TriggerEvent<Plane>(this, 0.95f);
        ...
        protected virtual void I1_PlanHeight(object o)
        {
            ...
            {
                this.height[item] = Plane.GetTerrainHeight(item, this.perlin, this.pathfindingArea, num, this.settings.mapBorders);
            }
