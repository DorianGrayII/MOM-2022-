...
namespace HutongGames.PlayMaker
{
    public static class ActionHelpers
    {
        ...
        public static bool IsMouseOver(GameObject gameObject, float distance, int layerMask)
        {
            ...
            return gameObject == ActionHelpers.MouseOver(distance, layerMask);
        }

        public static RaycastHit MousePick(float distance, int layerMask)
        {
            if (!ActionHelpers.mousePickRaycastTime.Equals(Time.frameCount) || ActionHelpers.mousePickDistanceUsed < distance || ActionHelpers.mousePickLayerMaskUsed != layerMask)
            {
        ...
        private static void DoMousePick(float distance, int layerMask)
        {
            if (!(Camera.main == null))
            {
                ...
                ActionHelpers.mousePickRaycastTime = Time.frameCount;
            }
        }
        ...
        {
            ActionHelpers.DebugLog(FsmExecutionStack.ExecutingFsm, LogLevel.Error, text, sendToUnityLog: true);
        }

        public static void LogWarning(string text)
        {
            ActionHelpers.DebugLog(FsmExecutionStack.ExecutingFsm, LogLevel.Warning, text, sendToUnityLog: true);
        }
        ...
        {
            return actionName + " : " + ActionHelpers.GetValueLabel(min) + " - " + ActionHelpers.GetValueLabel(max);
        }
        ...
        {
            return actionName + " : " + ActionHelpers.GetValueLabel(var) + " = " + ActionHelpers.GetValueLabel(value);
        }
        ...
        {
            return actionName.Replace("Convert", "") + " : " + ActionHelpers.GetValueLabel(fromVariable) + " to " + ActionHelpers.GetValueLabel(toVariable);
        }
        ...
        {
            return actionName + " : " + ActionHelpers.GetValueLabel(property) + " -> " + ActionHelpers.GetValueLabel(store);
        }
