namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, UIHint(UIHint.Variable), Title("Game Object"), Tooltip("A Game Object variable to compare.")]
        ...
        {
            bool flag = base.Fsm.GetOwnerDefaultTarget(this.gameObjectVariable) == this.compareTo.get_Value();
