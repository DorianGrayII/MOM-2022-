namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Physics2D), HutongGames.PlayMaker.Tooltip("Sets the Mass of a Game Object's Rigid Body 2D.")]
    public class SetMass2d : ComponentAction<Rigidbody2D>
    {
        ...
        [RequiredField, HasFloatSlider(0.1f, 10f), HutongGames.PlayMaker.Tooltip("The Mass")]
