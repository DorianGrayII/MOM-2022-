    ...
    public class AdventureManager
    {
        ...
        public static AdventureData TryToTriggerAdventure(Adventure a, PlayerWizard initiatorWizard, IGroup adventureSource, IGroup initiator, bool devMode = false)
        {
            ...
            if (initiator != null)
            {
                ...
                {
                    adventureData.adventurePlane = (initiator as Group).GetPlane();
                }
                else if (initiator is Location)
                {
                    adventureData.adventurePlane = (initiator as Location).GetPlane();
                }
            }
        ...
        private static IEnumerator _ResolveAIEvent(AdventureData ad, Adventure a)
        {
            ...
            do
            {
                ...
                else if (AdventureManager.curentNode is NodeWorldEnchantment)
                {
                    ...
                    if (enchantment != null)
                    {
                        ...
                        if (listByName != null)
                        {
                            ...
                            {
                                if (item is Reference<Unit>)
                                {
                                    (item as Reference<Unit>).Get().AddEnchantment(e, null, num, parameters);
                                }
                                else if (item is Reference<Location>)
                                {
                                    (item as Reference<Location>).Get().AddEnchantment(e, null, num, parameters);
                                }
                ...
                else if (AdventureManager.curentNode is NodeSpawnLocation)
                {
                    ...
                    else if (ad.advSource is Location)
                    {
                        (ad.advSource as Location).Destroy();
                    }
                ...
                else if (AdventureManager.curentNode is NodeBattle)
                {
                    ...
                    Group group = (Group)ScriptLibrary.Call(nodeBattle.scriptName, ad, AdventureManager.curentNode);
                    ...
                    if (!string.IsNullOrEmpty(nodeBattle.listA))
                    {
                        ...
                        if (listByName2 != null)
                        {
                            foreach (object item2 in listByName2.list)
                            {
                                if (item2 is Unit)
                                {
                                    list.Add(item2 as Unit);
                                }
                                else if (item2 is Group)
                                {
                                    list.AddRange((item2 as Group).GetUnits());
                                }
                            }
                        }
                    }
                ...
                else if (AdventureManager.curentNode is NodeLocationAward)
                {
                    ...
                    if (ad.advSource is Location)
                    {
                        Location location = ad.advSource as Location;
                ...
                {
                    if ((baseNode as NodeEnd).destroyEvent && ad.advSource is Location location2)
                    {
                ...
                else if (AdventureManager.curentNode is NodeWorldEnchantment)
                {
                    ...
                    if (enchantment != null)
                    {
                        ...
                        if (listByName != null)
                        {
                            ...
                            {
                                if (item6 is Reference<Unit>)
                                {
                                    (item6 as Reference<Unit>).Get().AddEnchantment(e, null, num, parameters);
                                }
                                else if (item6 is Reference<Location>)
                                {
                                    (item6 as Reference<Location>).Get().AddEnchantment(e, null, num, parameters);
                                }
                    ...
                    if (!string.IsNullOrEmpty(nodeBattle.listA))
                    {
                        ...
                        if (listByName2 != null)
                        {
                            foreach (object item7 in listByName2.list)
                            {
                                if (item7 is Unit)
                                {
                                    list.Add(item7 as Unit);
                                }
                                else if (item7 is Group)
                                {
                                    list.AddRange((item7 as Group).GetUnits());
                                }
                            }
                        }
                    }
                    ...
                    default:
                    {
                            ...
                            if (listByName3 != null)
                            {
                                foreach (object item8 in listByName3.list)
                                {
                                    if (item8 is Group)
                                    {
                                        ...
                                        (item8 as Group).GetUnits().ForEach(delegate(Reference<Unit> o)
                                        {
                                            playerWares.Add(o.Get());
                                        });
                                        continue;
                                    }
                                    if (item8 is Reference<Unit>)
                                    {
                                        if (playerWares == null)
                                        {
                                            playerWares = new List<object>();
                                        }
                                        Unit item = (item8 as Reference<Unit>).Get();
                        ...
                        foreach (object item9 in listByName3.list)
                        {
                            if (item9 is Group)
                            {
                                ...
                                (item9 as Group).GetUnits().ForEach(delegate(Reference<Unit> o)
                                {
