namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), ActionTarget(typeof(PlayMakerFSM), "gameObject,fsmName", false), HutongGames.PlayMaker.Tooltip("Set the value of a Material Variable in another FSM.")]
            ...
            if (this.setValue != null)
            {
                ...
                if (ownerDefaultTarget != null)
                {
                    ...
                    else
                    {
                        ...
                        if (fsmMaterial != null)
                        {
                            fsmMaterial.set_Value(this.setValue.get_Value());
                        }
                        else
                        {
