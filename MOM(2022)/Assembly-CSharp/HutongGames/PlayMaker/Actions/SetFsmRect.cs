namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), ActionTarget(typeof(PlayMakerFSM), "gameObject,fsmName", false), HutongGames.PlayMaker.Tooltip("Set the value of a Rect Variable in another FSM.")]
    public class SetFsmRect : FsmStateAction
    {
        ...
        [RequiredField, UIHint(UIHint.FsmRect), HutongGames.PlayMaker.Tooltip("The name of the FSM variable.")]
            ...
            if (this.setValue != null)
            {
                ...
                if (ownerDefaultTarget != null)
                {
                    ...
                    else
                    {
                        ...
                        if (fsmRect != null)
                        {
                            fsmRect.set_Value(this.setValue.get_Value());
                        }
                        else
                        {
