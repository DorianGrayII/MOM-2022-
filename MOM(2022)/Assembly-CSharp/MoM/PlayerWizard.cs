...
public class PlayerWizard : Entity, IEnchantable, IAttributable, ISpellCaster, IEventDisplayName
{
    ...
    [ProtoMember(30)]
    public List<Reference<global::MOM.Unit>> heroes = new List<Reference<global::MOM.Unit>>();
    ...
    [ProtoMember(41)]
    public List<global::MOM.Artefact> artefacts = new List<global::MOM.Artefact>();
    ...
    [ProtoIgnore]
    public global::MOM.Unit selectedSummon;
    ...
    public void AfterDeserialize()
    {
        ...
        {
            this.artefacts = new List<global::MOM.Artefact>();
        }
        if (this.heroes == null)
        {
            this.heroes = new List<Reference<global::MOM.Unit>>();
        }
    ...
    public void EndTurnUpdate()
    {
        ...
        foreach (global::MOM.Group item in GameManager.GetGroupsOfWizard(this.ID))
        {
            if (item.Action == global::MOM.Group.GroupActions.Skip)
            {
                item.Action = global::MOM.Group.GroupActions.None;
            }
        }
    }
    ...
    public int CalculateManaIncome(bool includeUpkeep = false, StatDetails details = null)
    {
        ...
        if (includeUpkeep)
        {
            ...
            foreach (global::MOM.Group registeredGroup in GameManager.Get().registeredGroups)
            {
                ...
                global::MOM.Group group = registeredGroup;
    ...
    public bool SummonToWorld(Spell spell)
    {
        if (spell.targetType.enumType == ETargetType.WorldSummon && this.summoningCircle != null)
        {
            ...
            {
                List<Reference<global::MOM.Unit>> units = this.summoningCircle.Get().GetUnits();
    ...
    public int GetTotalCastingSkill()
    {
        ...
        if (townLocation != null)
        {
            ...
            {
                foreach (Reference<global::MOM.Unit> unit in townLocation.GetUnits())
                {
            ...
            else if (FSMSelectionManager.Get() != null && FSMSelectionManager.Get().GetSelectedGroup() is global::MOM.Group group && group.beforeMovingAway == townLocation)
            {
    ...
    public void AddToDeadHeroesList(global::MOM.Unit u)
    {
    ...
    private IEnumerator FameHeroOffer()
    {
        ...
        List<Hero> list = DataBase.GetType<Hero>().FindAll((Hero o) => o.recruitmentCost <= this.money && o.recruitmentMinFame <= this.fame && (o.recruitmentMinBooks == null || this.GetAttributes().ContainsAll(o.recruitmentMinBooks)) && !global::MOM.Unit.HeroInUseByWizard(o, this.ID) && o.GetTag(TAG.EVENT_ONLY_UNIT) == 0 && !o.unresurrectable);
        if (list.Count <= 0)
        {
            yield break;
        }
        ...
        foreach (Hero item2 in list2)
        {
            ...
            global::MOM.Unit unit = global::MOM.Unit.CreateFrom(item2);
            unit.xp = num5;
        ...
        else
        {
            ...
            if ((locationTactic != null && locationTactic.dangerRank > 0) || (float)this.money * 0.8f > (float)unitOffer.cost)
            {
                ...
                global::MOM.Unit unit2 = unitOffer.unit;
        ...
        {
            global::MOM.Unit unit3 = item3.unit;
    ...
    private IEnumerator FameUnitOffer()
    {
        ...
        if (!GameManager.Get().registeredLocations.Any((global::MOM.Location o) => !o.GetPlane().arcanusType && o.GetOwnerID() == this.ID))
        {
        ...
        if (this.ID == PlayerWizard.HumanID())
        {
            global::MOM.Unit example = global::MOM.Unit.CreateFrom(pick);
            example.xp = exp;
            ...
            unitInfo.SetBuyInfo(uo, delegate
            {
                ...
                {
                    global::MOM.Unit unit2 = global::MOM.Unit.CreateFrom(pick);
                    unit2.xp = exp;
                    this.wizardTower.Get().AddUnit(unit2);
                    unit2.UpdateMP();
                }
        ...
        if ((locationTactic != null && locationTactic.dangerRank > 0) || (float)this.money * 0.6f > (float)cost)
        {
            ...
            {
                global::MOM.Unit unit = global::MOM.Unit.CreateFrom(pick);
                unit.xp = exp;
    ...
    private IEnumerator FameArtefactOffer()
    {
        ...
        global::MOM.Artefact artefact = global::MOM.Artefact.CraftRandomByBudget(this.money);
    ...
    {
        List<global::MOM.Group> groupsOfWizard = GameManager.GetGroupsOfWizard(this.ID);
        foreach (global::MOM.Group g in groupsOfWizard)
        {
    ...
    public IEnumerator FocusOnGroupWithMPLeft()
    {
        ...
        foreach (global::MOM.Group g in groupsOfWizard)
        {
            ...
            if (g.destination != Vector3i.invalid)
            {
                ...
                global::MOM.Group g2 = group as global::MOM.Group;
                if (group is global::MOM.Location location)
                {
            ...
            else if (g.CurentMP() > 0 && g.Action == global::MOM.Group.GroupActions.None && !g.isActivelyBuilding)
            {
                FSMSelectionManager.Get().Select(g, focus: true);
                yield break;
            }
    ...
    public bool AnyGroupsWithMPLeft()
    {
        if (this.IsHuman)
        {
            foreach (global::MOM.Group item in GameManager.GetGroupsOfWizard(this.ID))
            {
                if (item.alive && item.CurentMP() > 0 && item.Action == global::MOM.Group.GroupActions.None && !item.isActivelyBuilding)
                {
                    return true;
                }
            }
    ...
    public void SetGameScore(bool isVictory, bool masterOfMagicCasted)
    {
        ...
        List<global::MOM.Location> list = GameManager.GetLocationsOfWizard(this.ID).FindAll((global::MOM.Location o) => o is TownLocation);
