...
namespace MOM
{
    public class ArmyManager : ScreenBase
    {
        ...
        public override IEnumerator PreStart()
        {
            ...
            MHEventSystem.RegisterListener<Group>(delegate(object sender, object o)
            {
                Group item = sender as Group;
            ...
            {
                Group selectedObject = this.gridArmies.GetSelectedObject<Group>();
            ...
            this.gridUnusedItems.CustomDynamicItem(delegate(GameObject itemSource, object source, object data, int index)
            {
                ...
                itemSource.GetOrAddComponent<MouseClickEvent>().mouseRightClick = delegate
                {
                    ...
                    PopupGeneral.OpenPopup(null, "UI_SMASH_ARTEFACT", global::DBUtils.Localization.Get("UI_SMASH_ARTEFACT_DES", true, a.name, a.GetValue() / 2), "UI_OK", Artefact.SmashArtefact, "UI_CANCEL", null, null, null, a);
                };
            }, UpdateVault);
            this.UpdateVault();
            this.UpdateUpkeep();
        ...
        private void UpdateUpkeep()
        {
            ...
            if (groupsOfWizard != null)
            {
                ...
                {
                    foreach (Reference<Unit> unit in item.GetUnits())
                    {
        ...
        {
            this.groupList = new List<Group>(GameManager.Get().registeredGroups);
            this.groupList = this.groupList.FindAll((Group o) => o.GetOwnerID() == PlayerWizard.HumanID() && o.GetUnits().Count > 0 && (o.GetLocationHost()?.otherPlaneLocation?.Get() == null || o.plane.arcanusType));
        ...
        {
            List<Reference<Unit>> heroes = GameManager.GetHumanWizard().heroes;
