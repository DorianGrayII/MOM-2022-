...
public class Hex
{
    ...
    public void SetTerrain(Terrain t, global::WorldCode.Plane p)
    {
        this.terrain = t;
        this.terrainIndex = -1;
        bool num = this.HaveFlag(ETerrainType.Coast);
    ...
    public Terrain GetTerrain(MHRandom r, global::WorldCode.Plane p)
    {
    ...
    public int SeaAround(global::WorldCode.Plane p)
    {
        if (this.seaAround == -1)
        {
            this.seaAround = 0;
    ...
    private static Terrain FindTerrainOfType(MHRandom random, int flags, global::WorldCode.Plane p)
    {
