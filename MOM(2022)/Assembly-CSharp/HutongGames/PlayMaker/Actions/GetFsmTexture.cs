namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), ActionTarget(typeof(PlayMakerFSM), "gameObject,fsmName", false), HutongGames.PlayMaker.Tooltip("Get the value of a Texture Variable from another FSM.")]
        ...
        private void DoGetFsmVariable()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                if ((this.fsm != null) && (this.storeValue != null))
                {
                    ...
                    if (fsmTexture != null)
                    {
                        this.storeValue.set_Value(fsmTexture.get_Value());
                    }
                }
            }
        }
