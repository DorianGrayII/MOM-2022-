namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, CheckForComponent(typeof(Animation)), HutongGames.PlayMaker.Tooltip("The GameObject to add the Animation Clip to.")]
        public FsmOwnerDefault gameObject;
        [RequiredField, ObjectType(typeof(AnimationClip)), HutongGames.PlayMaker.Tooltip("The animation clip to add. NOTE: Make sure the clip is compatible with the object's hierarchy.")]
        ...
        private void DoAddAnimationClip()
        {
            ...
            {
                AnimationClip clip = this.animationClip.get_Value() as AnimationClip;
                if (clip != null)
                {
