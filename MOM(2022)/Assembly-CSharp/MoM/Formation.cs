    ...
    public class Formation : MonoBehaviour, IAttentionController
    {
        ...
        public static Formation CreateFormation(BaseUnit source, Vector3i position, IPlanePosition owner, Vector3 lookAtDir)
        {
            ...
            if (flag)
            {
                ...
                if (owner is Group)
                {
                    bool value = (owner as Group).isActivelyBuilding;
        ...
        private void OnEnable()
        {
            ...
            bool value = (this.owner as Group)?.isActivelyBuilding ?? false;
        ...
        private void Update()
        {
            ...
            else
            {
                ...
                if (this.lastIterationUpdate != num)
                {
                    ...
                    else if (this.source is Unit)
                    {
                        Reference<Group> group = (this.source as Unit).group;
                        if (group != null)
                        {
        ...
        public void UpdateFigureCount()
        {
            ...
            {
                bool flag = true;
                if (!(this.source is Unit) || (this.source as Unit).group != null)
                {
        ...
        public void Move(List<Vector3i> path, bool wastefullLastStep)
        {
            if (this.source == null || !base.gameObject.activeInHierarchy)
            {
                if (this.characters != null && this.owner is Group group)
                {
