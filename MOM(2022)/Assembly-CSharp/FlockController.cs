...
public class FlockController : MonoBehaviour
{
    ...
    public void AddChild(int amount)
    {
        ...
        {
            FlockChild flockChild = Object.Instantiate(this._childPrefab);
    ...
    public void SetFlockRandomPosition()
    {
        ...
        zero.x = Random.Range(0f - this._positionSphere, this._positionSphere) + this._thisT.position.x;
        zero.z = Random.Range(0f - this._positionSphereDepth, this._positionSphereDepth) + this._thisT.position.z;
        zero.y = Random.Range(0f - this._positionSphereHeight, this._positionSphereHeight) + this._thisT.position.y;
