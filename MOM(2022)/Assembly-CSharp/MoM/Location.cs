...
public class Location : Entity, IGroup, IEnchantable, IPlanePosition, IHashableGroup, IVisibilityChange, IEventDisplayName
{
    ...
    [ProtoMember(5)]
    public Reference<global::MOM.Group> localGroup;
    ...
    [ProtoMember(29)]
    public Reference<global::MOM.Location> otherPlaneLocation;
    ...
    [ProtoIgnore]
    public global::MOM.Group preBattleAttackers;
    ...
    public int owner
    {
        ...
        set
        {
            ...
            foreach (global::MOM.Location loc in GameManager.GetLocationsOfThePlane(this.plane))
            {
    ...
    public static global::MOM.Location CreateLocation(Vector3i position, global::WorldCode.Plane p, global::DBDef.Location source, int owner, bool skipMarker = true, bool spawnDefenders = true)
    {
        ...
        global::MOM.Location location = new global::MOM.Location();
        ...
        if (spawnDefenders)
        {
            if (source.locationType == ELocationType.PlaneTower)
            {
                ...
                {
                    global::MOM.Location locationAt = GameManager.Get().GetLocationAt(position, World.GetArcanus());
                ...
                {
                    group = (global::MOM.Group)ScriptLibrary.Call(source.guardianCreationScript, location, num4, false);
                    int num5 = 1;
                    while (group.GetUnits().Count <= 0)
                    {
                        num4 = 100;
                        group = (global::MOM.Group)ScriptLibrary.Call(source.guardianCreationScript, location, num4 * num5, false);
                        num5++;
                    }
                }
            ...
            {
                location.localGroup = new global::MOM.Group(location);
            }
        }
        ...
        if (TurnManager.GetTurnNumber() > 0)
        {
            ...
            foreach (global::MOM.Location loc in GameManager.GetLocationsOfThePlane(location.plane))
            {
                if (loc is TownLocation)
                {
                    surroundingArea.Find((Vector3i o) => o == loc.GetPosition());
    ...
    public virtual List<Reference<global::MOM.Unit>> GetUnits()
    {
    ...
    public global::MOM.Group GetLocalGroup()
    {
        if (this.localGroup == null && EntityManager.GetEntity(this.ID) != null)
        {
            this.localGroup = new global::MOM.Group(this);
        }
    ...
    public void RemoveUnit(global::MOM.Unit u, bool allowGroupDestruction = true, bool updateGroup = true)
    {
    ...
    {
        if (FSMSelectionManager.Get().GetSelectedGroup() is global::MOM.Group group && group.beforeMovingAway != null)
        {
    ...
    public void RemoveAdventureTrigger()
    {
        if (this.locationType == ELocationType.PlaneTower)
        {
            global::MOM.Location locationAt = GameManager.Get().GetLocationAt(this.position, World.GetOtherPlane(this.plane));
            if (locationAt.locationType == ELocationType.PlaneTower)
            {
    ...
    public static string CanBuildTownAtLocation(global::WorldCode.Plane p, Vector3i pos)
    {
        ...
        if (GameManager.GetLocationsOfThePlane(p).Find((global::MOM.Location o) => o is TownLocation && area.FindIndex((Vector3i k) => o.Position == k) > -1) == null)
        {
            return null;
        }
    ...
    public virtual void Conquer(global::MOM.Group g)
    {
        this.SetOwnerID(g.GetOwnerID(), -1, collateralDamage: true);
        this.AddUnitsIfPossible(g.GetUnits());
    }

    public static void PreBattle(global::MOM.Location location, global::MOM.Group attackers)
    {
        if (location == null)
        {
            return;
    ...
    public bool MeldAttempt(global::MOM.Unit u)
    {
        if (this.power <= 0)
        {
            return false;
    ...
    public global::MOM.Group FormExpedition()
    {
        List<Reference<global::MOM.Unit>> units = this.GetUnits();
        units = units.FindAll((Reference<global::MOM.Unit> o) => !o.Get().IsSettler() && !o.Get().IsEngineer() && !o.Get().IsMelder());
        if (units.Count < 1)
        {
            return null;
        }
        ...
        global::MOM.Group group = new global::MOM.Group(this.GetPlane(), this.GetOwnerID());
