...
namespace UnityEngine.PostProcessing
{
    ...
    public class BuiltinDebugViewsModel : PostProcessingModel
    {
        ...
        public bool willInterrupt
        {
            get
            {
                if (!this.IsModeActive(Mode.None) && !this.IsModeActive(Mode.EyeAdaptation) && !this.IsModeActive(Mode.PreGradingLog) && !this.IsModeActive(Mode.LogLut))
                {
                    return !this.IsModeActive(Mode.UserLut);
                }
                return false;
            }
        }
