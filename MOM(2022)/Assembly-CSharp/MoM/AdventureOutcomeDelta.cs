...
namespace MOM
{
    public class AdventureOutcomeDelta
    {
        ...
        private Dictionary<Unit, List<DBReference<Skill>>> unitSkills = new Dictionary<Unit, List<DBReference<Skill>>>();
        ...
        public void Store()
        {
            ...
            this.artefacts = new List<Artefact>(humanWizard.artefacts);
            foreach (Group item in GameManager.GetGroupsOfWizard(humanWizard.GetID()))
            {
                foreach (Reference<Unit> unit2 in item.GetUnits())
                {
        ...
        public List<Outcome> GetOutcomes()
        {
            ...
            this.ProcessList(this.artefacts, adventureOutcomeDelta.artefacts, delegate(Artefact a, int delta)
            {
            ...
            List<Unit> ignoreUnits = new List<Unit>();
            ...
            foreach (KeyValuePair<Unit, List<DBReference<Skill>>> kvp in this.unitSkills)
            {
