    ...
    public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
    {
        ...
        private void GenerateLut()
        {
            ...
            if (!this.IsLogLutValid(base.model.bakedLut))
            {
                ...
                RenderTexture texture1 = new RenderTexture(0x400, 0x20, 0, this.GetLutFormat());
                texture1.name = "Color Grading Log LUT";
                texture1.hideFlags = HideFlags.DontSave;
                texture1.filterMode = FilterMode.Bilinear;
                texture1.wrapMode = TextureWrapMode.Clamp;
                texture1.anisoLevel = 0;
                base.model.bakedLut = texture1;
            }
            ...
            else if (tonemapper == ColorGradingModel.Tonemapper.Neutral)
            {
        ...
        {
            return (!SystemInfo.SupportsTextureFormat(TextureFormat.RGBAHalf) ? TextureFormat.RGBA32 : TextureFormat.RGBAHalf);
        }
        ...
        private Texture2D GetCurveTexture()
        {
            ...
            {
                Texture2D textured1 = new Texture2D(0x80, 2, this.GetCurveFormat(), false, true);
                textured1.name = "Internal Curves Texture";
                ...
                this.m_GradingCurves = textured1;
            }
        ...
        public static unsafe Vector3 GetGainValue(Color gain)
        {
            ...
            float* singlePtr1 = &gain.a;
            singlePtr1[0] *= (gain.a > 0f) ? 3f : 1f;
        ...
        public static unsafe Vector3 GetGammaValue(Color gamma)
        {
            ...
            float num = ((color.r + color.g) + color.b) / 3f;
            float* singlePtr1 = &gamma.a;
            singlePtr1[0] *= (gamma.a < 0f) ? 0.8f : 5f;
            float b = Mathf.Pow(2f, (color.g - num) * 0.5f) + gamma.a;
            return ClampVector(new Vector3(1f / Mathf.Max((float) 0.01f, (float) (Mathf.Pow(2f, (color.r - num) * 0.5f) + gamma.a)), 1f / Mathf.Max(0.01f, b), 1f / Mathf.Max((float) 0.01f, (float) (Mathf.Pow(2f, (color.b - num) * 0.5f) + gamma.a))), 0f, 5f);
        }
        ...
        {
            return (!SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf) ? RenderTextureFormat.ARGB32 : RenderTextureFormat.ARGBHalf);
        }
        ...
        public static unsafe Vector3 GetPowerValue(Color power)
        {
            ...
            float num = ((color.r + color.g) + color.b) / 3f;
            float* singlePtr1 = &power.a;
            singlePtr1[0] *= 0.5f;
            float b = (((color.g - num) * 0.1f) + power.a) + 1f;
            return ClampVector(new Vector3(1f / Mathf.Max((float) 0.01f, (float) ((((color.r - num) * 0.1f) + power.a) + 1f)), 1f / Mathf.Max(0.01f, b), 1f / Mathf.Max((float) 0.01f, (float) ((((color.b - num) * 0.1f) + power.a) + 1f))), 0.5f, 2.5f);
        }
        ...
        {
            return ((lut != null) && (lut.IsCreated() && (lut.height == 0x20)));
        }
        ...
        public void OnGUI()
        {
            ...
            GUI.DrawTexture(new Rect((base.context.viewport.x * Screen.width) + 8f, 8f, (float) bakedLut.width, (float) bakedLut.height), bakedLut);
        }
        ...
        public override void Prepare(Material uberMaterial)
        {
            ...
            uberMaterial.EnableKeyword(base.context.profile.debugViews.IsModeActive(BuiltinDebugViewsModel.Mode.PreGradingLog) ? "COLOR_GRADING_LOG_VIEW" : "COLOR_GRADING");
            RenderTexture bakedLut = base.model.bakedLut;
        ...
        {
            return (((2.87f * x) - ((3f * x) * x)) - 0.2750951f);
        }
