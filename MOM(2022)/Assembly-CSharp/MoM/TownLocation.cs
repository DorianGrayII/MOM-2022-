...
namespace MOM
{
    ...
    public class TownLocation : Location
    {
        ...
        [ProtoIgnore]
        public List<Location> townLocations;
        ...
        public override int ConquerGold()
        {
            ...
            if (base.owner > 0)
            {
                ...
                int num2 = 0;
                List<Location> locationsOfWizard = GameManager.GetLocationsOfWizard(base.owner);
        ...
        public override int ConquerFame()
        {
            ...
            if (wizard != null)
            {
                ...
                if (GameManager.GetLocationsOfWizard(base.owner).FindAll((Location o) => o is TownLocation).Count < 2)
                {
                    num += 5;
                }
            }
        ...
        public void Raze(int attackerID)
        {
            ...
            if (flag)
            {
                Group group = base.GetLocalGroup();
                Group group2 = new Group(base.GetPlane(), attackerID);
        ...
        public override void Conquer(Group g)
        {
        ...
        public static TownLocation CreateLocation(Vector3i position, global::WorldCode.Plane p, Town source, int size, int owner)
        {
            ...
            List<Location> locations = GameManager.Get().registeredLocations;
            List<string> list = new List<string>(townName.names);
            list.RandomSort();
            string value = list.Find((string o) => locations.FindIndex((Location k) => k is TownLocation && (k as TownLocation).name == o) == -1);
        ...
        {
            int num = 0;
            foreach (Location townLocation in this.GetTownLocations())
            {
        ...
        public FInt GetProductionInArea()
        {
            ...
            {
                this.productionInArea = Location.GetProductionInArea(base.GetPlane(), base.GetPosition(), this.GetTownRange());
        ...
        public List<Location> GetTownLocations()
        {
        ...
        private void UpdateCachedTownLocations()
        {
            ...
            this.townLocations = new List<Location>();
            global::WorldCode.Plane p = base.GetPlane();
            foreach (Vector3i v in this.GetSurroundingArea(this.GetTownRange()))
            {
                Location location = GameManager.GetLocationsOfThePlane(p).Find((Location o) => o.GetPosition() == v);
                if (location != null)
                {
        ...
        public int GetRebels(StatDetails sd = null)
        {
            ...
            if (FSMSelectionManager.Get() != null && FSMSelectionManager.Get().GetSelectedGroup() is Group group && group.beforeMovingAway == this)
            {
        ...
        public int CalculatePowerIncome(StatDetails sd = null)
        {
            ...
            if (base.GetWizardOwner() != null)
            {
                ...
                foreach (Location townLocation in this.townLocations)
                {
        ...
        public void TurnToRuin()
        {
            ...
            Location location = Location.CreateLocation(base.GetPosition(), base.GetPlane(), type[index], 0);
            List<Reference<Unit>> units = location.localGroup.Get().GetUnits();
        ...
        public bool CanSeeInside()
        {
            ...
            List<Group> groupsOfPlane = GameManager.GetGroupsOfPlane(base.GetPlane());
