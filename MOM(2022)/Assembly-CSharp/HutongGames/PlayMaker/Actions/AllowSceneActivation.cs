namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Scene), Tooltip("Allow scenes to be activated. Use this after LoadSceneAsynch where you did not activated the scene upon loading")]
    public class AllowSceneActivation : FsmStateAction
    {
        [RequiredField, UIHint(UIHint.Variable), Tooltip("The name of the new scene. It cannot be empty or null, or same as the name of the existing scenes.")]
        public FsmInt aSynchOperationHashCode;
        [Tooltip("Allow the scene to be activated")]
        public FsmBool allowSceneActivation;
        [ActionSection("Result"), Tooltip("The loading's progress."), UIHint(UIHint.Variable)]
        public FsmFloat progress;
        [Tooltip("True when loading is done"), UIHint(UIHint.Variable)]
