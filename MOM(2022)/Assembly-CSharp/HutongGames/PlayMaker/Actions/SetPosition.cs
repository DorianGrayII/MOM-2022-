...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class SetPosition : FsmStateAction
    {
        ...
        private void DoSetPosition()
        {
            ...
            {
                Vector3 vector = ((!this.vector.IsNone) ? this.vector.Value : ((this.space == Space.World) ? ownerDefaultTarget.transform.position : ownerDefaultTarget.transform.localPosition));
                if (!this.x.IsNone)
                {
