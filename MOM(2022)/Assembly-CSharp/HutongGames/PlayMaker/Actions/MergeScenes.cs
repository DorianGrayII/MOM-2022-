namespace HutongGames.PlayMaker.Actions
{
    ...
    public class MergeScenes : FsmStateAction
    {
        ...
        [ActionSection("Destination"), Tooltip("The reference options of the destination Scene")]
        ...
        [ActionSection("Result"), Tooltip("True if the merge succeeded"), UIHint(UIHint.Variable)]
        ...
        {
            return (((this.sourceReference != GetSceneActionBase.SceneAllReferenceOptions.ActiveScene) || (this.destinationReference != GetSceneActionBase.SceneAllReferenceOptions.ActiveScene)) ? string.Empty : "Source and Destination scenes can not be the same");
        }
        ...
        private void GetDestinationScene()
        {
            ...
            if (this._destinationScene == scene)
            {
