...
namespace UnityEngine.PostProcessing
{
    public sealed class ScreenSpaceReflectionComponent : PostProcessingComponentCommandBuffer<ScreenSpaceReflectionModel>
    {
        ...
        public override bool active
        {
            get
            {
                if (base.model.enabled && base.context.isGBufferAvailable)
                {
        ...
        public override void PopulateCommandBuffer(CommandBuffer cb)
        {
            ...
            int num2 = base.context.width / num;
            int num3 = base.context.height / num;
            float num4 = base.context.width;
            float num5 = base.context.height;
            float num6 = num4 / 2f;
            float num7 = num5 / 2f;
            Material material = base.context.materialFactory.Get("Hidden/Post FX/Screen Space Reflection");
            ...
            for (int j = 1; j < 5; j++)
            {
                int num8 = this.m_ReflectionTextures[j - 1];
                int num9 = j;
                ...
                num8 = this.m_ReflectionTextures[j];
