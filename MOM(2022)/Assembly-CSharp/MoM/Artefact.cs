...
public class Artefact : IEventDisplayName
{
    ...
    public static global::MOM.Artefact Craft(global::DBDef.Artefact source)
    {
        global::MOM.Artefact artefact = new global::MOM.Artefact();
    ...
    public static global::MOM.Artefact RandomFactory(int points, EEquipmentType[] factoryByMatch = null, bool reportError = true)
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            for (int j = 0; j < 4; j++)
            {
                ...
                list3.Add(power);
                points -= power.cost;
                list2 = list2.FindAll((ArtefactPower o) => o.cost <= points && global::MOM.Artefact.GetSet(o) != global::MOM.Artefact.GetSet(power));
                if (list2.Count < 1)
                {
                    break;
                }
            }
            global::MOM.Artefact artefact = global::MOM.Artefact.Craft(b, list3);
            global::MOM.Artefact.AddGuarantedPowers(artefact);
            return artefact;
        }
        return null;
    }

    public static global::MOM.Artefact Craft(ArtefactPrefab source, List<ArtefactPower> powers)
    {
        global::MOM.Artefact artefact = new global::MOM.Artefact();
        artefact.name = source.GetDescriptionInfo().GetLocalizedName();
        ...
        {
            global::MOM.Artefact.UTIL_SetAlternativeGraphic(artefact, source);
        }
        return artefact;
    }

    public static global::MOM.Artefact Craft(ArtefactPrefab source, List<ArtefactPower> powers, int minPower, int maxPower)
    {
        global::MOM.Artefact artefact = global::MOM.Artefact.Craft(source, powers);
        ...
        {
            list = list.FindAll((ArtefactPower o) => global::MOM.Artefact.GetSet(o) != global::MOM.Artefact.GetSet(v.Get()));
        }
        if (list.Count > 0)
        {
            ...
            for (int i = 0; i < 4 - artefact.artefactPowers.Count; i++)
            {
                ...
                list2.Add(power);
                points -= power.cost;
                list = list.FindAll((ArtefactPower o) => o.cost <= points && global::MOM.Artefact.GetSet(o) != global::MOM.Artefact.GetSet(power));
                if (list.Count < 1)
                {
                    break;
                }
    ...
    public static global::MOM.Artefact CraftRandomByBudget(int budget, bool preferPremade = true)
    {
        if (preferPremade && global::UnityEngine.Random.Range(0, 100) < 50)
        {
            ...
            if (artefactsList.Count > 0)
            {
                ...
                return global::MOM.Artefact.Craft(artefactsList[0]);
            }
        }
        return global::MOM.Artefact.RandomFactory(budget, null, reportError: false);
    }

    public static void SmashArtefact(object o)
    {
        if (o is global::MOM.Artefact)
        {
            global::MOM.Artefact artefact = o as global::MOM.Artefact;
            ...
            if (humanWizard.artefacts.Contains(artefact))
            {
                ...
                MHEventSystem.TriggerEvent<global::MOM.Artefact>(o, "Smashed");
                return;
            }
            foreach (Reference<global::MOM.Unit> hero in humanWizard.heroes)
            {
    ...
    {
        if (global::MOM.Artefact.artefactPowerToSet == null)
        {
            global::MOM.Artefact.artefactPowerToSet = new Dictionary<ArtefactPower, ArtefactPowerSet>();
        }
        if (!global::MOM.Artefact.artefactPowerToSet.ContainsKey(power))
        {
            ...
            global::MOM.Artefact.artefactPowerToSet[power] = artefactPowerSet;
        }
        return global::MOM.Artefact.artefactPowerToSet[power];
    }

    private static void EnsurePowersByPopulated()
    {
        if (global::MOM.Artefact.spellsByEquipmentType != null)
        {
            return;
        }
        global::MOM.Artefact.spellsByEquipmentType = new Dictionary<int, List<ArtefactPower>>();
        global::MOM.Artefact.bonusesByEquipmentType = new Dictionary<int, List<ArtefactPower>>();
        foreach (ArtefactPower item in DataBase.GetType<ArtefactPower>())
        {
            ...
            foreach (EEquipmentType eEquipmentType in eTypes)
            {
                ...
                {
                    global::MOM.Artefact.AddPower(global::MOM.Artefact.spellsByEquipmentType, (int)eEquipmentType, item);
                }
                else
                {
                    global::MOM.Artefact.AddPower(global::MOM.Artefact.bonusesByEquipmentType, (int)eEquipmentType, item);
                }
                if ((eEquipmentType & (EEquipmentType)15872) != 0)
                {
                    if (set.requiredTag != null && set.requiredTag.Length != 0)
                    {
                        global::MOM.Artefact.AddPower(global::MOM.Artefact.spellsByEquipmentType, 15872, item);
                    }
                    else
                    {
                        global::MOM.Artefact.AddPower(global::MOM.Artefact.bonusesByEquipmentType, 15872, item);
                    }
                }
            }
        }
        foreach (List<ArtefactPower> value in global::MOM.Artefact.bonusesByEquipmentType.Values)
        {
            value.Sort(delegate(ArtefactPower a, ArtefactPower b)
            {
                int num = global::MOM.Artefact.GetSet(a).dbName.CompareTo(global::MOM.Artefact.GetSet(b).dbName);
                if (num == 0)
                {
                    num = a.cost - b.cost;
                }
    ...
    {
        global::MOM.Artefact.EnsurePowersByPopulated();
        if (!global::MOM.Artefact.spellsByEquipmentType.TryGetValue(equipmentType, out var result))
        {
            return global::MOM.Artefact.noPowers;
        }
        return result;
    }
    ...
    {
        global::MOM.Artefact.EnsurePowersByPopulated();
        if (!global::MOM.Artefact.bonusesByEquipmentType.TryGetValue(equipmentType, out var result))
        {
            return global::MOM.Artefact.noPowers;
        }
        return result;
    ...
    public static global::MOM.Artefact FactoryByRequirements(List<LogicRequirementGroup> requirementGroups, int min, int max)
    {
        List<List<object>> list = new List<List<object>>();
        global::MOM.Artefact.UTIL_ConstructArtefactFactoryOption(requirementGroups, 0, null, list);
        new List<global::MOM.Artefact>();
        ...
        foreach (List<object> item in list)
        {
            ...
            {
                global::MOM.Artefact artefact = global::MOM.Artefact.Craft(ap, aps, min, max);
                if (artefact != null)
                {
                    return artefact;
                }
    ...
    private static void UTIL_ConstructArtefactFactoryOption(List<LogicRequirementGroup> requirementGroups, int requrementsIndex, List<object> branchOption, List<List<object>> combinedList)
    {
        ...
        for (int i = 0; i < logicRequirementGroup.options.Count; i++)
        {
            ...
            if (dBClass != null)
            {
                ...
                global::MOM.Artefact.UTIL_ConstructArtefactFactoryOption(requirementGroups, requrementsIndex + 1, list, combinedList);
            }
        }
    }

    private static void UTIL_SetAlternativeGraphic(global::MOM.Artefact a, ArtefactPrefab source)
    {
    ...
    private static void AddGuarantedPowers(global::MOM.Artefact a)
    {
