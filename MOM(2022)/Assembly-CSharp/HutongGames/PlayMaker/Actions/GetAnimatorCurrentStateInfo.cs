namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Animator), HutongGames.PlayMaker.Tooltip("Gets the current State information on a specified layer")]
        ...
        private void GetLayerInfo()
        {
            if (this._animator != null)
            {
                ...
                if (!this.loopCount.IsNone || !this.currentLoopProgress.IsNone)
                {
                    ...
                    this.currentLoopProgress.Value = currentAnimatorStateInfo.normalizedTime - this.loopCount.Value;
                }
            }
        }
