...
public class Unit : BaseUnit
{
    ...
    public static global::MOM.Unit CreateFrom(Subrace source, bool simulation = false)
    {
        global::MOM.Unit unit = new global::MOM.Unit();
        ...
        if (source is Hero)
        {
            ...
            foreach (global::MOM.Group registeredGroup in gameManager.registeredGroups)
            {
                foreach (Reference<global::MOM.Unit> unit3 in registeredGroup.GetUnits())
                {
    ...
    public bool NewTurn()
    {
        ...
        {
            FInt fInt = FInt.ZERO;
            foreach (Reference<global::MOM.Unit> unit in this.group.Get().GetUnits())
            {
    ...
    public void Destroy()
    {
        if (this.group != null)
        {
            ...
            MHEventSystem.TriggerEvent<global::MOM.Unit>(this, "Destroy");
        }
    ...
    public void ApplyImmolationDamage(int[] damage, MHRandom random, int defenceModifier, Spell spell = null, bool replaceDefenceWithModifier = false, StringBuilder sb = null, string header = null)
    {
        ...
        int num = 0;
        int num2 = damage[num];
        MHEventSystem.TriggerEvent<global::MOM.Unit>(this, new UnitEvent(damage));
    ...
    public void ApplyDoomDmg(int dam, BattleAttack battleAttack, StringBuilder sb = null, string header = null)
    {
        ...
        MHEventSystem.TriggerEvent<global::MOM.Unit>(this, new UnitEvent(dam));
        BattleFigure battleFigure = new BattleFigure(this, base.attributes);
        while (base.currentFigureHP >= 0)
        {
    ...
    public static bool HeroInUse(Subrace s)
    {
        ...
        foreach (PlayerWizard wizard in GameManager.GetWizards())
        {
            ...
            {
                foreach (Reference<global::MOM.Unit> hero in wizard.heroes)
                {
    ...
    public static bool HeroInUseByWizard(Subrace s, int wizardId)
    {
        ...
        {
            foreach (Reference<global::MOM.Unit> hero in GameManager.GetWizard(wizardId).heroes)
            {
