...
public class SmoothCameraOrbit : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        {
            this.desiredDistance -= (((Input.GetAxis("Mouse Y") * 0.02f) * this.zoomRate) * 0.125f) * Mathf.Abs(this.desiredDistance);
        }
        ...
        this.desiredDistance -= ((Input.GetAxis("Mouse ScrollWheel") * 0.02f) * this.zoomRate) * Mathf.Abs(this.desiredDistance);
