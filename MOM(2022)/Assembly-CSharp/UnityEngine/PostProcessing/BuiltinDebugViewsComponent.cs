namespace UnityEngine.PostProcessing
{
    ...
    public sealed class BuiltinDebugViewsComponent : PostProcessingComponentCommandBuffer<BuiltinDebugViewsModel>
    {
        ...
        {
            return ((base.model.settings.mode == BuiltinDebugViewsModel.Mode.MotionVectors) ? CameraEvent.BeforeImageEffects : CameraEvent.BeforeImageEffectsOpaque);
        }

        public override DepthTextureMode GetCameraFlags()
        {
            DepthTextureMode none = DepthTextureMode.None;
            switch (base.model.settings.mode)
            {
        ...
        private void MotionVectorsPass(CommandBuffer cb)
        {
            ...
            if ((motionVectors.motionImageOpacity > 0f) && (motionVectors.motionImageAmplitude > 0f))
            {
                ...
                cb.Blit((RenderTargetIdentifier) nameID, num2, mat, 3);
