...
public class DevMenu : ScreenBase
{
    ...
    protected override void ButtonClick(Selectable s)
    {
        ...
        if (s == this.addUnitOnMap)
        {
            ...
            {
                global::MOM.Unit unit = global::MOM.Unit.CreateFrom((Subrace)DataBase.Get(this.unitDropdown.GetSelection(), reportMissing: false));
        ...
        if (s == this.addEnemyWizardUnitOnMap)
        {
            ...
            if (this.enemyWizardUnitDropdown.GetSelection() != null)
            {
                ...
                global::MOM.Group group = new global::MOM.Group(World.GetActivePlane(), wizard.ID);
                group.Position = hexCoordAt;
                group.AddUnit(global::MOM.Unit.CreateFrom((Subrace)dBClass));
        ...
        if (s == this.addEnemyNeutralUnitOnMap)
        {
            if (this.enemyNeutralUnitDropdown.GetSelection() != null)
            {
                ...
                group2.AddUnit(global::MOM.Unit.CreateFrom((Subrace)dBClass2));
        ...
        if (s == this.addRes)
        {
            ...
            if (humanWizard3.summoningCircle != null && this.resDropdown.GetSelection() != null)
            {
                ...
                TownLocation townLocation = (TownLocation)GameManager.Get().registeredLocations.Find((global::MOM.Location o) => o.Position == townPosition);
        ...
        if (s == this.addXp)
        {
            ...
            if (humanWizard6.summoningCircle != null)
            {
                ...
                List<global::MOM.Group> list = GameManager.Get().registeredGroups.FindAll((global::MOM.Group o) => o.GetPosition() == city.Get().GetPosition() && o.GetPlane() == city.Get().GetPlane() && (o.GetLocationHost()?.otherPlaneLocation?.Get() == null || o.plane.arcanusType));
                List<Reference<global::MOM.Unit>> list2 = new List<Reference<global::MOM.Unit>>();
                foreach (global::MOM.Group item3 in list)
                {
                ...
                if (list2.Count > 0)
                {
                    foreach (Reference<global::MOM.Unit> item4 in list2)
                    {
                        item4.Get().xp += result;
                    }
                }
        ...
        {
            List<global::MOM.Artefact> artefacts = GameManager.GetHumanWizard().artefacts;
            if (artefacts != null && this.artefactDropdown.GetSelection() != null)
            {
                global::MOM.Artefact item = global::MOM.Artefact.Craft(DataBase.Get(this.artefactDropdown.GetSelection(), reportMissing: false) as global::DBDef.Artefact);
                artefacts.Add(item);
            }
            UIManager.Close(this);
        }
        ...
        if (s == this.killEnemyWizard)
        {
            foreach (PlayerWizard w2 in GameManager.GetWizards())
            {
                ...
                List<global::MOM.Group> list3 = GameManager.Get().registeredGroups.FindAll((global::MOM.Group o) => o.GetOwnerID() == w2.ID && (o.GetLocationHost()?.otherPlaneLocation?.Get() == null || o.plane.arcanusType));
                w2.GetTowerLocation().Destroy();
                foreach (global::MOM.Group item5 in list3)
                {
                    item5.Destroy();
                }
                break;
        ...
        if (s == this.killYourself)
        {
            ...
            foreach (global::MOM.Group item6 in GameManager.Get().registeredGroups.FindAll((global::MOM.Group o) => o.GetOwnerID() == w.ID && (o.GetLocationHost()?.otherPlaneLocation?.Get() == null || o.plane.arcanusType)))
            {
                item6.Destroy();
            }
        ...
        if (s == this.castSpell)
        {
            ...
            if (this.castSpellDropdown.GetSelection() != null)
            {
                ...
                {
                    List<global::MOM.Group> registeredGroups2 = GameManager.Get().registeredGroups;
                    if (spell.targetType == DataBase.Get<TargetType>(TARGET_TYPE.UNIT_ENEMY))
                    {
                        global::MOM.Unit unit2 = registeredGroups2.Find((global::MOM.Group o) => o.GetOwnerID() == v.GetID()).GetUnits()[0];
                    ...
                    {
                        global::MOM.Unit unit3 = registeredGroups2.Find((global::MOM.Group o) => o.GetOwnerID() == caster.GetID()).GetUnits()[0];
                        ScriptLibrary.Call(spell.worldScript, caster, unit3, spell);
                    }
                    else
                    {
                        global::MOM.Unit unit4 = registeredGroups2.Find((global::MOM.Group o) => o.GetOwnerID() == v.GetID()).GetUnits()[0];
                ...
                case ETargetType.TargetGroup:
                {
                    ...
                    {
                        global::MOM.Group group3 = registeredGroups.Find((global::MOM.Group o) => o.GetOwnerID() == v.GetID());
                    ...
                    {
                        global::MOM.Group group4 = registeredGroups.Find((global::MOM.Group o) => o.GetOwnerID() == caster.GetID());
                        ScriptLibrary.Call(spell.worldScript, caster, group4, spell);
                    }
                    else
                    {
                        global::MOM.Group group5 = registeredGroups.Find((global::MOM.Group o) => o.GetOwnerID() == v.GetID());
                ...
                case ETargetType.TargetLocation:
                {
                    ...
                    {
                        global::MOM.Location location = registeredLocations.Find((global::MOM.Location o) => o.GetOwnerID() == v.GetID());
                    ...
                    {
                        global::MOM.Location location2 = registeredLocations.Find((global::MOM.Location o) => o.GetOwnerID() == caster.GetID());
                        ScriptLibrary.Call(spell.worldScript, caster, location2, spell);
                    }
                    else
                    {
                        global::MOM.Location location3 = registeredLocations.Find((global::MOM.Location o) => o.GetOwnerID() == v.GetID());
                ...
                {
                    global::MOM.Location towerLocation = v.GetTowerLocation();
