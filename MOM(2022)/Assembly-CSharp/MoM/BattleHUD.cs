...
public class BattleHUD : ScreenBase
{
    ...
    {
        global::MOM.Unit unit = sender as global::MOM.Unit;
        global::MOM.Unit.UnitEvent unitEvent = e as global::MOM.Unit.UnitEvent;
    ...
    public static void StoreUnitInfo()
    {
        ...
        MHEventSystem.RegisterListener<global::MOM.Unit>(OnUnitEvent, BattleHUD.instance);
