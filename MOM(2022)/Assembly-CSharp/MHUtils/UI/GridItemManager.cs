...
public class GridItemManager : ToggleGroup, IEndDragHandler, IEventSystemHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public global::MHUtils.Callback onSelectionChange;

    public global::MHUtils.Callback onUpdate;

    public global::MHUtils.Callback onPageChange;
    ...
    public void CustomDynamicItem(CustomDynamicItemMethod callback, global::MHUtils.SimpleCallback onPageChange = null)
    {
        this.Initialize();
    ...
    public void AddCallback(global::MHUtils.SimpleCallback c)
    {
