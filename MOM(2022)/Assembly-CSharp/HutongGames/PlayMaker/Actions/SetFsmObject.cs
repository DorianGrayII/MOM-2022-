namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), ActionTarget(typeof(PlayMakerFSM), "gameObject,fsmName", false), HutongGames.PlayMaker.Tooltip("Set the value of an Object Variable in another FSM.")]
    public class SetFsmObject : FsmStateAction
    {
        ...
        [RequiredField, UIHint(UIHint.FsmObject), HutongGames.PlayMaker.Tooltip("The name of the FSM variable.")]
            ...
            if (this.setValue != null)
            {
                ...
                if (ownerDefaultTarget != null)
                {
                    ...
                    else
                    {
                        ...
                        if (fsmObject != null)
                        {
                            fsmObject.set_Value(this.setValue.get_Value());
                        }
                        else
                        {
