...
public class Group : Entity, IGroup, IPlanePosition, IHashableGroup, IVisibilityChange
{
    ...
    [ProtoMember(6)]
    public List<Reference<global::MOM.Unit>> groupUnits;
    ...
    [ProtoMember(12)]
    public Reference<global::MOM.Location> locationHost;

    [ProtoMember(13)]
    public Reference<global::MOM.Location> beforeMovingAway;
    ...
    [ProtoMember(26)]
    public Reference<global::MOM.Unit> transporter;
    ...
    public Vector3i Position
    {
        ...
        set
        {
            ...
            {
                if (entity.Value is IPlanePosition planePosition && planePosition != this && (planePosition is global::MOM.Group || planePosition is global::MOM.Location) && planePosition.GetPlane() == this.GetPlane() && planePosition.GetPosition() == this.GetPosition())
                {
    ...
    public Group(global::MOM.Location parent)
    {
        this.maxMPCache = -1;
        ...
        this.planeSerializableReference = this.plane.planeSource;
        this.locationHost = new Reference<global::MOM.Location>();
    ...
    public void Destroy()
    {
        ...
        MHEventSystem.TriggerEvent<global::MOM.Group>(this, "Destroy");
    }

    public List<Reference<global::MOM.Unit>> GetUnits()
    {
        if (this.groupUnits == null)
        {
            this.groupUnits = new List<Reference<global::MOM.Unit>>();
        }
        return this.groupUnits;
    }

    public void AddUnit(global::MOM.Unit u, bool updateMovementFlags = true)
    {
        ...
        for (; i < 3; i++)
        {
            foreach (Vector3i v in HexNeighbors.GetRange(this.GetPosition(), i, i))
            {
                ...
                {
                    global::MOM.Group group = groupsOfPlane.Find((global::MOM.Group o) => o.GetPosition() == v);
                    if (group == null)
                    {
                        global::MOM.Group group2 = new global::MOM.Group(this.GetPlane(), this.GetOwnerID());
    ...
    private void Add(global::MOM.Unit u, bool updateMovementFlags = true)
    {
        if (u.group == this)
        {
            return;
    ...
    public void RemoveUnit(global::MOM.Unit leaver, bool allowGroupDestruction = true, bool updateGroup = true)
    {
        if (leaver == null)
        {
            return;
        ...
        foreach (Reference<global::MOM.Unit> unit2 in this.GetUnits())
        {
            global::MOM.Unit unit = unit2.Get();
        ...
        if (allowGroupDestruction && this.GetUnits().Count == 0)
        {
            ...
            {
                MHEventSystem.TriggerEvent<global::MOM.Group>(this, "GroupEmpty");
            }
        }
        (this.GetLocationHost() as TownLocation)?.GroupChanged();
        if (this.GetLocationHost() == null)
    ...
    public void UpdateMapFormation(bool createIfMissing = true, bool forceDirty = false)
    {
        ...
        else
        {
            ...
            Reference<global::MOM.Unit> reference = null;
            this.Dirty = false;
            if (this.transporter == null)
            {
                List<Reference<global::MOM.Unit>> units = this.GetUnits();
                bool flag = this.GetOwnerID() == PlayerWizard.HumanID();
                Reference<global::MOM.Unit> reference2 = ((units.Count > 0) ? units[0] : null);
                for (int i = 0; i < units.Count; i++)
                {
                    Reference<global::MOM.Unit> reference3 = units[i];
    ...
    public void TransferUnits(global::MOM.Group g)
    {
        ...
        {
            List<Reference<global::MOM.Unit>> units2 = g.GetUnits();
    ...
    public void TransferUnit(global::MOM.Group g, global::MOM.Unit u)
    {
        List<Reference<global::MOM.Unit>> units = this.GetUnits();
    ...
    public void EnsureHasMP(int mp = 1)
    {
        if (this.transporter != null)
        {
            global::MOM.Unit unit = this.transporter.Get();
            if (unit.Mp < mp)
            {
                unit.Mp = new FInt(mp);
            }
        ...
        foreach (Reference<global::MOM.Unit> unit3 in this.GetUnits())
        {
            global::MOM.Unit unit2 = unit3.Get();
            if (unit2.Mp < mp)
            {
    ...
    public IGroup MoveViaPath(List<Vector3i> path, bool mergeCollidedAlliedGroups, bool enterCollidedAlliedTowns = true, bool aggressive = true, bool costMP = true)
    {
        ...
        if (group != null)
        {
            ...
            this.destination = Vector3i.invalid;
            if (group is global::MOM.Group)
            {
                flag = true;
            }
            else if (group is global::MOM.Location location)
            {
        ...
        if (group != null)
        {
            ...
            if (group.GetOwnerID() == this.GetOwnerID())
            {
                ...
                if (!mergeCollidedAlliedGroups && group is global::MOM.Group && group is global::MOM.Group group2 && group2.GetLocationHostSmart() == null)
                {
                    return this;
                }
            ...
            else if (aggressive || (group is global::MOM.Location location2 && location2.GetUnits().Count == 0))
            {
                if (group is global::MOM.Group)
                {
                    if (HexCoordinates.HexDistance(this.GetPosition(), (group as global::MOM.Group).GetPosition()) == 1 && this.beforeMovingAway != null)
                    {
                        global::MOM.Location location3 = this.beforeMovingAway.Get();
                        if (FSMSelectionManager.Get().GetSelectedGroup() != this)
                        {
                ...
                else if (group is global::MOM.Location location4)
                {
                    if (this.GetOwnerID() == PlayerWizard.HumanID())
                    {
                        location4.MarkAsExplored();
                    }
                    global::MOM.Group group3 = this;
                    if (HexCoordinates.HexDistance(group3.GetPosition(), location4.GetPosition()) == 1 && this.beforeMovingAway != null)
                    {
                        global::MOM.Location location5 = this.beforeMovingAway.Get();
                        if (FSMSelectionManager.Get().GetSelectedGroup() != this)
                        {
                    ...
                    {
                        global::MOM.Location.PreBattle(group as TownLocation, group3);
                        ...
                        else
                        {
                            ...
                            {
                                group3.ChangeBeforeMovingAway(group as global::MOM.Location);
                            }
                        }
                    }
                }
        ...
        if (path.Count < 2)
        {
            MHEventSystem.TriggerEvent<global::MOM.Group>(this, null);
            return this;
        }
        if (this.GetOwnerID() == PlayerWizard.HumanID())
        {
        ...
        MHEventSystem.TriggerEvent<global::MOM.Group>(this, path);
        return this;
    }
    ...
    public FInt CurentMP()
    {
        ...
        if (this.SubsetSelected())
        {
            ...
            {
                foreach (global::MOM.Unit selectedUnit in FSMSelectionManager.Get().selectedUnits)
                {
    ...
    public int GetMaxMP()
    {
        if (this.SubsetSelected())
        {
            ...
            List<Reference<global::MOM.Unit>> list = new List<Reference<global::MOM.Unit>>(selectedUnits.Count);
    ...
    public IGroup CutByCollision(List<Vector3i> path)
    {
        ...
        {
            num = i;
            global::MOM.Group group2 = groupsOfPlane.Find((global::MOM.Group o) => o.GetPosition() == path[i]);
            ...
            global::MOM.Location location = locationsOfThePlane.Find((global::MOM.Location o) => o.GetPosition() == path[i]);
            if (location != null)
            {
                group = location;
    ...
    public void NewTurn()
    {
        ...
        {
            global::MOM.Unit unit = this.GetUnits()[num].Get();
            if (!(unit.group != this))
            {
    ...
    {
        global::MOM.Location location = this.GetLocationHost();
    ...
    public bool CanSubsetTravelWater(List<Reference<global::MOM.Unit>> list, global::MOM.Unit exceptThisUnit = null)
    {
        if (list == null)
        {
            return false;
    ...
    public void UpdateSelectedHaveTransporter(List<global::MOM.Unit> list = null)
    {
        if (list == null)
        {
        ...
        this.transporter = null;
        foreach (global::MOM.Unit item in list)
        {
    ...
    {
        Reference<global::MOM.Unit> reference = this.transporter;
        this.transporter = null;
        foreach (Reference<global::MOM.Unit> unit in this.GetUnits())
        {
    ...
    public bool BuildTown()
    {
        ...
        else
        {
            ...
            settler.Destroy();
            global::MOM.Unit u = global::MOM.Unit.CreateFrom(PowerEstimate.GetList().Find((Multitype<BattleUnit, int> o) => o.t0.race == settler.dbSource.Get().race && o.t0.GetAttFinal(TAG.TOWN_STARTING_DEFENDER) > 0 && DataBase.GetType<global::DBDef.Unit>().Contains(o.t0.dbSource.Get() as global::DBDef.Unit)).t0.dbSource);
            if (this.GetOwnerID() > 0)
            {
    ...
    public bool CanBuildTown()
    {
        ...
        if (this.GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get().IsSettler()) != null)
        {
            return global::MOM.Location.CanBuildTownAtLocation(this.GetPlane(), this.GetPosition()) == null;
        }
        return false;
    }

    public global::MOM.Location GetLocationHostSmart()
    {
        if (this.locationHost == null)
        {
    ...
    public global::MOM.Location GetLocationHost()
    {
        return this.locationHost;
    }
    ...
    public global::MOM.Group PlaneSwitch(List<global::MOM.Unit> selectedUnits = null)
    {
        if (this.GetLocationHostSmart() != null && this.GetLocationHostSmart().otherPlaneLocation != null)
        {
            if (this.GetOwnerID() == PlayerWizard.HumanID())
            {
                ...
                global::MOM.Location g = ((this.GetLocationHostSmart().GetPlane() == otherPlane) ? this.GetLocationHostSmart() : this.GetLocationHostSmart().otherPlaneLocation.Get());
                FSMSelectionManager.Get().Select(g, focus: true);
            }
            return this;
        }
        global::MOM.Group group = GameManager.GetGroupsOfPlane(World.GetOtherPlane(this.GetPlane())).Find((global::MOM.Group o) => o.GetPosition() == this.GetPosition() && o.GetOwnerID() == this.GetOwnerID());
        if (group == null)
        {
            group = new global::MOM.Group(World.GetOtherPlane(this.GetPlane()), this.GetOwnerID());
        }
    ...
    public void ForcedToMoveOut()
    {
        ...
        global::MOM.Group group = this;
        if (this.IsHosted())
        {
            global::MOM.Group group2 = new global::MOM.Group(World.GetActivePlane(), this.GetOwnerID());
        ...
        if (area != null)
        {
            ...
            {
                if (groupsOfPlane.Find((global::MOM.Group o) => o.GetPosition() == v) == null)
                {
                    vector3i = v;
                    break;
                }
    ...
    public IEnumerator AIMoveOut(bool guaranteeMP, global::MOM.Unit unit, Destination destination, AIGroupDesignation.Designation designation, List<Vector3i> path)
    {
        global::MOM.Group g = this;
        if (this.IsHosted() || this.GetUnits().Count > 1)
        {
            g = new global::MOM.Group(g.GetPlane(), g.GetOwnerID());
            g.AddUnit(unit);
            if (guaranteeMP)
            {
                unit.RegainTo1MP();
    ...
    public void TriggerOnJoinScripts(global::MOM.Unit u)
    {
    ...
    public global::MOM.Group GetGroup()
    {
        return this;
    }

    public void TakeOverLocation(global::MOM.Location loc)
    {
        ...
        if (obj != null && this.aiNeturalExpedition != null)
        {
            if (this.aiNeturalExpedition.spawnLocation?.Get() == null)
            {
                if (Random.Range(0, 100) < 50)
                {
                    ...
                    if (list != null)
                    {
                        ...
                        global::MOM.Location.CreateLocation(vector3i, p, source, 0);
                    }
                }
                else
                {
            ...
            List<Reference<global::MOM.Unit>> units = loc.GetUnits();
            if (units.Count > 0)
            {
                for (int num = units.Count - 1; num >= 0; num--)
                {
        ...
        else
        {
            ...
            List<Reference<global::MOM.Unit>> units2 = loc.GetUnits();
            if (units2.Count > 0)
            {
    ...
    public bool SharePositionWith(global::MOM.Group g)
    {
    ...
    public void ChangeBeforeMovingAway(global::MOM.Location g)
    {
    ...
    public global::MOM.Unit KickOutSettler()
    {
        Reference<global::MOM.Unit> reference = this.GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get().IsSettler());
        if (reference == null)
        {
            return null;
        }
    ...
    public global::MOM.Unit KickOutEngineer()
    {
        Reference<global::MOM.Unit> reference = this.GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get().IsEngineer());
        if (reference == null)
        {
            return null;
        }
    ...
    public global::MOM.Unit KickOutMelder()
    {
        Reference<global::MOM.Unit> reference = this.GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get().IsMelder());
        if (reference == null)
        {
            return null;
        }
    ...
    public void KickOutUnit(global::MOM.Unit u, AIGroupDesignation.Designation d)
    {
        GameManager.GetWizard(this.GetOwnerID());
        bool flag = this.GetUnits().Count > 1 || this.IsHosted();
        Reference<global::MOM.Unit> reference = this.GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get() == u);
        if (!(reference != null))
        {
            return;
        }
        ...
        if (flag)
        {
            group = new global::MOM.Group(this.GetPlane(), this.GetOwnerID());
            group.Position = this.GetPosition();
    ...
    public void SellUnit(Reference<global::MOM.Unit> reference)
    {
