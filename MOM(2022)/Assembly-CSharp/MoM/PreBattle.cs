...
namespace MOM
{
    public class PreBattle : ScreenBase
    {
        ...
        public override void OnStart()
        {
            base.OnStart();
            Battle battle = Battle.GetBattle();
            Group group = ((battle.gAttacker != null) ? battle.gAttacker : battle.gDefender);
            if (group != null)
            {
        ...
        protected override void ButtonClick(Selectable s)
        {
            ...
            else if (s == this.btDontEngage)
            {
                ...
                {
                    Group playerGroup = battle3.gAttacker;
                    Group group = GameManager.GetGroupsOfWizard(playerGroup.GetOwnerID()).Find((Group o) => o.SharePositionWith(playerGroup));
