namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Scene), Tooltip("Loads the scene by its name or index in Build Settings. ")]
    public class LoadScene : FsmStateAction
    {
        ...
        [Tooltip("Allows you to specify whether or not to load the scene additively. See LoadSceneMode Unity doc for more information about the options."), ObjectType(typeof(LoadSceneMode))]
        public FsmEnum loadSceneMode;
        [ActionSection("Result"), Tooltip("True if the scene was loaded")]
