...
public class TooltipSurveyor : TooltipBase
{
    ...
    public override void Refresh()
    {
        ...
        bool flag3 = false;
        List<global::MOM.Location> locationsOfThePlane = GameManager.GetLocationsOfThePlane(activePlane);
        if (locationsOfThePlane != null)
        {
            global::MOM.Location location = locationsOfThePlane.Find((global::MOM.Location o) => o.GetPosition() == TooltipSurveyor.currentHex.Position);
            if (location != null)
            {
        ...
        global::MOM.Location locationAt = GameManager.Get().GetLocationAt(TooltipSurveyor.currentHex.Position);
        ...
        if (locationAt != null)
        {
            ...
            if (flag4)
            {
                ...
                foreach (Reference<global::MOM.Unit> unit in locationAt.GetUnits())
                {
        ...
        string text = global::MOM.Location.CanBuildTownAtLocation(activePlane, TooltipSurveyor.currentHex.Position);
