...
public class PurificationManager
{
    ...
    public PurificationManager(global::MOM.Group g, bool virtualVariant = false)
    {
        this.owner = g;
    ...
    {
        global::MOM.Group group = sender as global::MOM.Group;
    ...
    public IEnumerator TurnUpdate()
    {
        ...
        while (true)
        {
            ...
            while (this.owner.Get().CurentMP() > 0)
            {
                ...
                if (GameManager.GetLocationsOfThePlane(plane).Find((global::MOM.Location o) => o.GetPosition() == destination) != null)
                {
                    this.pathToWorkOn.RemoveAt(0);
                    continue;
                }
                if (GameManager.GetGroupsOfPlane(plane).Find((global::MOM.Group o) => o.GetPosition() == destination) != null)
                {
                    this.pathToWorkOn.RemoveAt(0);
                    continue;
                }
            ...
            FInt zERO = FInt.ZERO;
            foreach (Reference<global::MOM.Unit> unit in this.owner.Get().GetUnits())
            {
    ...
    {
        if (!(this.owner.Get().GetUnits().Find((Reference<global::MOM.Unit> o) => o.Get().IsPurifier()) != null))
        {
            this.Destroy();
        }
    }
