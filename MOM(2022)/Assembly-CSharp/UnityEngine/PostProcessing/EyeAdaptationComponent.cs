namespace UnityEngine.PostProcessing
{
    ...
    public sealed class EyeAdaptationComponent : PostProcessingComponentRenderTexture<EyeAdaptationModel>
    {
        ...
        public void OnGUI()
        {
            ...
            {
                GUI.DrawTexture(new Rect((base.context.viewport.x * Screen.width) + 8f, 8f, (float) this.m_DebugHistogram.width, (float) this.m_DebugHistogram.height), this.m_DebugHistogram);
            }
        }
        ...
        public Texture Prepare(RenderTexture source, Material uberMaterial)
        {
            ...
            else
            {
                ...
                RenderTexture texture2 = this.m_AutoExposurePool[++autoExposurePingPing % 2];
                Graphics.Blit(this.m_AutoExposurePool[++autoExposurePingPing % 2], texture2, mat, (int) settings.adaptationType);
                this.m_AutoExposurePingPing = ++autoExposurePingPing % 2;
                this.m_CurrentAutoExposure = texture2;
            }
            if (base.context.profile.debugViews.IsModeActive(BuiltinDebugViewsModel.Mode.EyeAdaptation))
            {
                if ((this.m_DebugHistogram == null) || !this.m_DebugHistogram.IsCreated())
                {
                    RenderTexture texture1 = new RenderTexture(0x100, 0x80, 0, RenderTextureFormat.ARGB32);
                    texture1.filterMode = FilterMode.Point;
                    texture1.wrapMode = TextureWrapMode.Clamp;
                    this.m_DebugHistogram = texture1;
                }
        ...
        public override bool active
        {
            get
            {
                return (base.model.enabled && (SystemInfo.supportsComputeShaders && !base.context.interrupted));
            }
        }
