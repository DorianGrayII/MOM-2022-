...
[global::HutongGames.PlayMaker.Tooltip("GUILayout Toolbar. NOTE: Arrays must be the same length as NumButtons or empty.")]
public class GUILayoutToolbar : GUILayoutAction
{
    [global::HutongGames.PlayMaker.Tooltip("The number of buttons in the toolbar")]
    public FsmInt numButtons;

    [global::HutongGames.PlayMaker.Tooltip("Store the index of the selected button in an Integer Variable")]
    [UIHint(UIHint.Variable)]
    public FsmInt selectedButton;

    [global::HutongGames.PlayMaker.Tooltip("Event to send when each button is pressed.")]
    public FsmEvent[] buttonEventsArray;

    [global::HutongGames.PlayMaker.Tooltip("Image to use on each button.")]
    public FsmTexture[] imagesArray;

    [global::HutongGames.PlayMaker.Tooltip("Text to use on each button.")]
    public FsmString[] textsArray;

    [global::HutongGames.PlayMaker.Tooltip("Tooltip to use for each button.")]
    public FsmString[] tooltipsArray;

    [global::HutongGames.PlayMaker.Tooltip("A named GUIStyle to use for the toolbar buttons. Default is Button.")]
    public FsmString style;

    [global::HutongGames.PlayMaker.Tooltip("Update the content of the buttons every frame. Useful if the buttons are using variables that change.")]
