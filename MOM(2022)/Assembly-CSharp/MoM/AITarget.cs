...
public class AITarget
{
    ...
    [ProtoMember(21)]
    public Reference<global::MOM.Group> targetAssignee;
    ...
    public AITarget(int owner, Entity target)
    {
        ...
        if (target is global::MOM.Location location && location.GetWizardOwner() != null)
        {
    ...
    public static bool IsTargetStrengthInteresting(global::MOM.Location location)
    {
        if (location == null)
        {
            return false;
    ...
    public void Inizialization()
    {
        ...
        foreach (Reference<global::MOM.Unit> unit in this.GetAsGroup().GetUnits())
        {
    ...
    public bool ValidateTarget()
    {
        ...
        if (entity is global::MOM.Location location)
        {
        ...
        else if (entity is global::MOM.Group group)
        {
            if (!group.alive)
            {
                return false;
    ...
    {
        global::MOM.Group assignee = this.GetAssignee();
        if (!this.ValidateTarget() || assignee == null)
        {
            this.targetAchievable = false;
            yield break;
        }
        global::MOM.Group asGroup = this.GetAsGroup();
    ...
    public void UpdateSupplyTowns()
    {
        ...
        List<global::MOM.Location> locationsOfThePlane = GameManager.GetLocationsOfThePlane(this.targetAssignee.Get().GetPlane());
    ...
    private void FindNewAssignee()
    {
        ...
        List<global::MOM.Group> groupsOfPlane = GameManager.GetGroupsOfPlane(asIPlanePosition.GetPlane());
        int num = 0;
        ...
        {
            global::MOM.Group group = this.targetAssignee.Get().GetLocationHost().FormExpedition();
            this.targetAssignee = null;
    ...
    private global::MOM.Location GetAsLocation()
    {
        return this.target?.Get() as global::MOM.Location;
    }

    public global::MOM.Group GetAsGroup()
    {
        if (this.target?.Get() is global::MOM.Group result)
        {
            return result;
        }
        return (this.target?.Get() as global::MOM.Location)?.GetLocalGroup();
    }

    private global::MOM.Group GetAssignee()
    {
    ...
    private bool CanGroupReachTarget(global::MOM.Group g)
    {
