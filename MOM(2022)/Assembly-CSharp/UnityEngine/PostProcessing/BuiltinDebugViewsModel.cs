namespace UnityEngine.PostProcessing
{
    ...
    public class BuiltinDebugViewsModel : PostProcessingModel
    {
        ...
        public bool willInterrupt
        {
            get
            {
                return (!this.IsModeActive(Mode.None) && (!this.IsModeActive(Mode.EyeAdaptation) && (!this.IsModeActive(Mode.PreGradingLog) && (!this.IsModeActive(Mode.LogLut) && !this.IsModeActive(Mode.UserLut)))));
            }
        }
        ...
        public struct MotionVectorsSettings
        {
            ...
            [UnityEngine.PostProcessing.Min(0f), Tooltip("Because motion vectors are mainly very small vectors, you can use this setting to make them more visible.")]
            ...
            [UnityEngine.PostProcessing.Min(0f), Tooltip("Tweaks the arrows length.")]
