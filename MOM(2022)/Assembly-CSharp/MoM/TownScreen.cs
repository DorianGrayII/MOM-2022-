...
public class TownScreen : ScreenBase
{
    ...
    private List<global::MOM.Unit> selectedUnits;

    private List<global::MOM.Location> townList;
    ...
    private void InitializeTopPanel()
    {
        ...
        List<global::MOM.Location> cities = GameManager.GetLocationsOfWizard(GameManager.GetHumanWizard().GetID()).FindAll((global::MOM.Location o) => o is TownLocation && ((TownLocation)o).GetTownSize() > TownSize.Outpost);
    ...
    {
        this.townList = GameManager.GetLocationsOfWizard(PlayerWizard.HumanID()).FindAll((global::MOM.Location o) => o is TownLocation && ((TownLocation)o).GetTownSize() > TownSize.Outpost);
        ...
        this.gridStatoningUnits.onSelectionChange = delegate(ArmyGrid grid)
        {
            ...
            {
                this.selectedUnits = new List<global::MOM.Unit>();
            }
            this.selectedUnits.Clear();
            foreach (BaseUnit selected in grid.selectedList)
            {
                this.selectedUnits.Add(selected as global::MOM.Unit);
            }
        };
    }
    ...
    private void UpdateLeftPanel(bool ignoreTowns = false)
    {
        if (!ignoreTowns)
        {
            ...
            int num = this.townList.FindIndex((global::MOM.Location o) => o == this.town) / this.gridAllTowns.GetPageSize();
    ...
    public override IEnumerator PreClose()
    {
        ...
        global::MOM.Group localGroup = this.town.GetLocalGroup();
    ...
    public List<global::MOM.Unit> GetSelectedUnits()
    {
