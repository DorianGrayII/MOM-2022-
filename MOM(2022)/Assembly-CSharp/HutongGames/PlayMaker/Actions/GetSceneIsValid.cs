namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Scene), Tooltip("Get a scene isValid flag. A scene may be invalid if, for example, you tried to open a scene that does not exist. In this case, the scene returned from EditorSceneManager.OpenScene would return False for IsValid. ")]
    public class GetSceneIsValid : GetSceneActionBase
    {
        [ActionSection("Result"), UIHint(UIHint.Variable), Tooltip("true if the scene is loaded.")]
