namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), ActionTarget(typeof(PlayMakerFSM), "gameObject,fsmName", false), HutongGames.PlayMaker.Tooltip("Get the value of a Game Object Variable from another FSM.")]
            ...
            if (this.storeValue != null)
            {
                ...
                if (ownerDefaultTarget != null)
                {
                    ...
                    if (this.fsm != null)
                    {
                        ...
                        {
                            this.storeValue.set_Value(fsmGameObject.get_Value());
                        }
                    }
                }
            }
