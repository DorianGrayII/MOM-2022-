...
// CSharpCompiler.ScriptBundleLoader
using System;
...
public class ScriptBundleLoader
{
    public class ScriptBundle
    {
        ...
        private void CompileFiles()
        {
            ...
            CompilerResults compilerResults = new global::CSharpCompiler.CodeCompiler().CompileAssemblyFromFileBatch(compilerParameters, this.filePaths.ToArray());
