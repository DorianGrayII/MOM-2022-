namespace UnityEngine.UI.Extensions
{
    ...
    public class SoftMaskScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if ((bool)base.GetComponent<Text>())
            {
                this.isText = true;
        ...
        {
            Transform parentTranform = base.transform;
            int num = 100;
            int num2 = 0;
            while (this.canvas == null && num2 < num)
            {
                this.canvas = parentTranform.gameObject.GetComponent<Canvas>();
                if (this.canvas == null)
                {
                    parentTranform = this.GetParentTranform(parentTranform);
                }
                num2++;
            }
        }
        ...
        private void SetMask()
        {
            ...
            this.mat.SetFloat("_HardBlend", this.HardBlend ? 1 : 0);
