namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.UI), HutongGames.PlayMaker.Tooltip("Gets the value of a UI Slider component.")]
    public class UiSliderGetValue : ComponentAction<Slider>
    {
        ...
        [RequiredField, UIHint(UIHint.Variable), HutongGames.PlayMaker.Tooltip("The value of the UI Slider component.")]
